...
public class AccountMapper {
    ...
    // response
    public static AccountMessages.GetAccountResponse toAccountResponse(Account account) {
        return AccountMessages.GetAccountResponse.newBuilder()
                .setId(account.getId())
    ...
    public static AccountMessages.CreateAccountResponse toCreateAccountResponse(Account account) {
        return AccountMessages.CreateAccountResponse.newBuilder()
                .setId(account.getId())
                .setUserId(account.getUserId())
                .setBalance(account.getBalance())
                .build();
