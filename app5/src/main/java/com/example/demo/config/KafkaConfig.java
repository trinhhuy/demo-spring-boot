...
public class KafkaConfig {
    ...
    public ProducerFactory<String, String> producerFactory() {
        ...
        configProps.put(ProducerConfig.RETRY_BACKOFF_MS_CONFIG, 1000); // thời gian chờ giữa các lần retry (ms)
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        props.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, false); // TTT
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory() {
        ...
        factory.getContainerProperties().setAckMode(org.springframework.kafka.listener.ContainerProperties.AckMode.MANUAL); // TTT
        return factory;
    }
}